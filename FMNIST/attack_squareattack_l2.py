...
class SquareAttacks(object):
    ...
    def generate(self,
                 ...
                 max_iter=100,
                 eps=0.3,):
        save_path = 'data/SquareAttack-L2/'
        log = open(save_path+'log.txt', 'w')
        print("SquareAttack_L2 Attack Information:", file=log)
        ...
        attack = SquareAttack(estimator=classifier, norm=norm, max_iter=max_iter, eps=eps)
...
if __name__ == "__main__":
    adv_generation = SquareAttacks()
    adv_generation.generate(norm=2, max_iter=100, eps=0.3)
