...
class HopSkipJumpAttack(object):
    ...
    def generate(self,
                 norm=np.inf,
                 targeted=False):
        save_path = 'data/HopSkipJumpAttack-Inf/'
        log = open(save_path+'log.txt', 'w')
        print("HopSkipJump-Inf Attack Information:", file=log)
        ...
        attack = HopSkipJump(classifier=classifier, norm=norm, targeted=targeted)
...
if __name__ == "__main__":
    adv_generation = HopSkipJumpAttack()
