...
from art.attacks.evasion import FastGradientMethod, DeepFool, CarliniL2Method, CarliniLInfMethod, BoundaryAttack, \
    ...
    SimBA, SpatialTransformation, SquareAttack, Wasserstein, ZooAttack, ProjectedGradientDescentTensorFlowV2
...
class PGD(object):
    ...
    def generate(self,
                 norm=2):
        save_path = 'data/PGD-L2/'
        log = open(save_path+'log.txt', 'w')
        print("PGD-L2 Attack Information:", file=log)
        ...
        attack = ProjectedGradientDescentTensorFlowV2(estimator=classifier, norm=norm)
...
if __name__ == "__main__":
    adv_generation = PGD()
    adv_generation.generate(norm=2)
