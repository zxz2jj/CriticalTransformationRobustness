...
class WassersteinAttack(object):
    ...
    def generate(self,
                 norm='2',
                 targeted=False):
        save_path = 'data/WassersteinAttack/'
        ...
        attack = Wasserstein(estimator=classifier, norm=norm, targeted=targeted)
...
if __name__ == "__main__":
    adv_generation = WassersteinAttack()
    adv_generation.generate(targeted=False, norm='2')
